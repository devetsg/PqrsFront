...
@Component({
  selector: 'app-index-contralor',
  templateUrl: './index-contralor.component.html',
  styleUrl: './index-contralor.component.scss'
})
export class IndexContralorComponent {
   displayedColumns: string[] = ['pqrId','reception','creation','document','usuario','radication','typepqr','regional','statusMiner','opts'];
    ...
    getPqrs() {
      this._serviceP.getPqrsContralor().subscribe({
        next: (data: any) => {
          console.log(data)
