...
import { CreateUpdateSecundaryComponent } from '../create-update-secundary/create-update-secundary.component';
...
export class IndexSecundaryComponent {
  ...
  openCreateDialog() {
    const dialogRef = this.dialog.open(CreateUpdateSecundaryComponent, {
      width: '500px',
